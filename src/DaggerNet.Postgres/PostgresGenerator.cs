...
{
  public class PostgresGenerator : SqlGenerator
  {
    ...
    static PostgresGenerator()
    {
      ...
      _type_map.Add(SqlType.Json, "json");
    }
    ...
    public override string[] SystemDatabases
    {
    ...
    public override long GetDatabaseSize(string name)
    {
